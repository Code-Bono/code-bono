...
// const webhookRouterCreator = (io, app) => {
//   io.on('connection', socket => {
//     console.log(
//       `A socket connection to the server has been made for webhooks: ${
//         socket.id
//       }`
//     )
...
//       console.log(
//         `Connection ${socket.id} (for webhooks) has left the building`
//       )
//     })

//     app.post('/webhook/pull_request', (req, res, next) => {
...
//     app.post('/webhook/pull_request_review', (req, res, next) => {
...
//       }
//       Event.create(newEvent)
//         .then(event => socket.emit('githubEvent', event))
//         .then(() => res.sendStatus(200))
//     })

//     app.post('/webhook/push', (req, res, next) => {
//       // size is the number of commits merged by the push event
//       let size = req.body.commits.length
//       let pathLength = req.body.ref.split('/').length
//       let branch = req.body.ref.split('/')[pathLength - 1]
...
//     app.post('/webhook/member', (req, res, next) => {
...
// module.exports = webhookRouterCreator
